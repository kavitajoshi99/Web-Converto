  ...
  <div class="calculator-container">
    <div class="table-container">
      <table class="table">
        ...
        <tr class="table-row">
          <td class="unary_oper" data-val="sin">sin</td>
          <td class="unary_oper" data-val="cos">cos</td>
          <td class="unary_oper" data-val="tan">tan</td>
          <td class="unary_oper" data-val="log">log</td>
          <td class="unary_oper" data-val="ln">ln</td>
        </tr>
        <tr class="table-row">
        ...
        <tr class="table-row">
          ...
          <td class="unary_oper" data-val="log2">log<sub>2<sub></td>
        </tr>
      </table>
    </div>
  </div>
